    ...
    return (
        <div className="p-4 mx-auto max-w-[1400px]">
            ...
            {contacts.length === 0 ? (
                ...
                <div className="text-center text-gray-500 mt-20 text-lg font-bold">
                    등록된 문의가 없습니다.
                    ...
                    <div className="bg-white rounded-lg p-6 w-full max-w-md ">
                        ...
                        <div className="mb-4">
                            <p className="font-medium mb-2"> 현재 상태:
                                {selectedContact.status === "in progress"
                                    ? "진행중" : selectedContact.status == "pending"
                                        ? "대기중" : "완료"}
                            </p>
                            <div className="space-y-2">
                                ...
                                <button
                                    ...
                                    className="w-full px-4 py-2 bg-blue-100 text-yellow-800 rounded hover:bg-yellow-200">
                                    진행중
                                </button>
                                <button
                        ...
                        <div className="flex justify-end space-x-2">
                            <button
                                ...
                                className="w-full px-4 py-2 bg-gray-100 text-gray-800 rounded hover:bg-green-200">
                                진행중
                            </button>
                        </div>
                    </div>
